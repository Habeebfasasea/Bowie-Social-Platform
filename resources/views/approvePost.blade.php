    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="text-center">
                <h1><b>Approved Posts ({{count($posts)}})</b></h1>
                    
            </div>           
            <div class="text-center mb-3">
                <a href="{{ route('pendPosts') }}"><button class="btn btn-outline-secondary" type="submit">Pending Posts</button></a>
                <a href="{{route('awaitingRevision')}}"><button class="btn btn-outline-warning" type="submit">Awaiting Revision</button></a>
            ...
            @foreach($posts as $post)
                <div class="card mb-5">
                    ...
                    <div class="text-center mb-2 mt-2">
                        ...
                        <a  class="btn btn-warning"  onclick="toggleRevise('{{$post->id}}')">Revise</a>
                        ...
                        <div class="container text-center mt-4">
                            <form action="{{route('awaiting.update',  $post->slug)}}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="revise_reason"></textarea>
                                </div>
                                <div class="mb-3">
                        ...
                        <div class="container text-center mt-4">
                            <form action="{{route('rejected.update',  $post->slug)}}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="reject_reason"></textarea>
                                </div>
                                <div class="mb-3">

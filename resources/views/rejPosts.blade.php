    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="text-center">
                <h1><b>Rejected Posts({{count($posts)}})</b></h1>
            ...
            @foreach($posts as $post)
                <div class="card mb-5">
                    ...
                    <p class="card-text"><small class="text-muted">Reject Reason: {{$post->reject_reason}}</small></p>
                    </div>
                    <div class="text-center mb-2 mt-2">
                        <a href="{{route('appPosts.posts',$post->id)}}" class="btn btn-primary">Approve Post</a>
                        <a class="btn btn-warning" onclick="toggleRevise('{{$post->id}}')">Revise Post</a>
                        <a href="{{route('disAppPostsPen.posts',$post->id)}}" class="btn btn-secondary">Set To Pending</a>
                    </div>
                    {{-- Revise Fprm --}}
